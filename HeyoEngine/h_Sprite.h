...
namespace Heyo {
	...
	public:
		...
		bool loadSprite(std::string imgAddress, int indiWidth = -1, int indiHeight = -1, int numX = 1, int numY = 1);
		...
		void setColorPercent(Uint8 red = 255, Uint8 green = 255, Uint8 blue = 255) { m_image.setColorPercent(red, green, blue); }
